...
<table width="98%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  ...
  <tr bgcolor="#CCFF99">
  	<td height="19" colspan="8" bgcolor="#FF9900">&nbsp;<a href="details.php">Details</a>&nbsp;&nbsp;&nbsp;<a href="full_list_admin.php">All Offices</a></td>
  </tr>
 <tr>
    <td colspan="8" bgcolor="#FF9900"><img src="mm_spacer.gif" alt="" width="1" height="1" border="0" /></td>
  </tr>
 ...
 <tr>
   ...
   <td colspan="6" valign="top" bgcolor="#FFFFFF"><div align="center"><form id="form7" name="form7" method="post" action="new_office.html">
 ...
 <tr>
    ...
    <td width="439" bgcolor="#FFFFFF" valign="top"><p><a href="office_admin.php">Office Name</a></p>
    <p><a href="office_admin.php">Office Name</a></p>
    <p><a href="office_admin.php">Office Name</a></p></td>
    <td colspan="6" valign="top" bgcolor="#FFFFFF"><span class="style2"><img src="mm_spacer.gif" alt="" width="305" height="1" border="0" /><br />
      ...
      <p>Type Code:
        <label>
        <input type="text" name="searchtypecode" id="searchtypecode" />
        </label>
      </p>
      <p>Street Address: 
        <label>
        <input type="text" name="searchstreet" id="searchstreet" />
        </label>
      </p>
      <p>Suburb: 
        <label>
        <input type="text" name="searchsuburb" id="searchsuburb" />
        </label>
      </p>
      <p>Postcode: 
        <label>
        <input type="text" name="searchpostcode" id="searchpostcode" />
        </label>
      </p>
      <p>State: 
        <label></label>
