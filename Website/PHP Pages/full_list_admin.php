...
<table width="98%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  ...
  <tr bgcolor="#CCFF99">
  	<td height="19" colspan="8" bgcolor="#FF9900">&nbsp;<a href="details.html">Details</a>&nbsp;&nbsp;&nbsp;<a href="adminofficelist.html">Offices</a></td>
  </tr>
 <tr>
    <td colspan="8" bgcolor="#FF9900"><img src="mm_spacer.gif" alt="" width="1" height="1" border="0" /></td>
  </tr>
 ...
 <tr>
   ...
   <td bgcolor="#FFFFFF" valign="top"><h1>All Offices</h1></td>
...
$query = "SELECT name, officeCode FROM office";
